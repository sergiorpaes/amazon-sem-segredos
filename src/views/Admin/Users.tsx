            ...
            {loading ? (
                ...
                <>
                    ...
                    {totalCount > itemsPerPage && (
                        <div className="mt-6 flex items-center justify-between bg-white dark:bg-dark-800 px-6 py-4 rounded-xl border border-gray-200 dark:border-dark-700">
                            ...
                            <div className="flex gap-2">
                                <button
                                    ...
                                    className="px-4 py-2 text-sm font-medium bg-gray-100 dark:bg-dark-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-200 dark:hover:bg-dark-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                                >
                                    Previous
                                </button>
                                <div className="flex items-center px-4 py-2 text-sm font-medium bg-brand-50 dark:bg-brand-900/20 text-brand-700 dark:text-brand-400 rounded-lg">
