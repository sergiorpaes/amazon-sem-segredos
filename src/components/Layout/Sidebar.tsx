...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const menuItems = [
    ...
    { id: DashboardModule.BRAND_FINDER, label: t('module.brand_finder'), icon: Award, disabled: !features.BRAND_FINDER },
    { id: DashboardModule.SUBCATEGORIES, label: t('subcategories.title'), icon: Layers, disabled: !features.SUBCATEGORIES },
    { id: DashboardModule.SELLER_ANALYZER, label: t('sellers.title'), icon: Store, disabled: !features.SELLER_ANALYZER },
    { id: DashboardModule.TRAFFIC_MAP, label: t('traffic.title'), icon: Network, disabled: !features.TRAFFIC_MAP },
    ...
    { id: DashboardModule.SUPPLIER_FINDER, label: t('module.supplier_finder'), icon: Users, disabled: !features.SUPPLIER_FINDER },
