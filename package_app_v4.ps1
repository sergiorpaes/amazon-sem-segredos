...
$tempDir = Join-Path $projectPath "temp_dist_source_final_v4"
...
$robocopyParams = @(
    ...
    $tempDir,
    "/E",
    "/XD", "node_modules", ".git", "dist", ".netlify", ".gemini", "temp_dist_source_final", "temp_dist_source_final_v2", "temp_dist_source_final_v3", "temp_dist_source_final_v4"
)
